        ...
        <div className={styles.heroInner}>
          ...
          <div className={`${styles.heroContent} ${visible ? styles.visible : ''}`}>
            ...
            <p className={styles.heroDesc}>
              I craft intuitive digital experiences that merge aesthetics with functionality. Based in Ahmedabad, Gujarat — turning complex problems into elegant design solutions.
            </p>
            ...
            <div className={styles.heroSkills}>
              ...
              <span className={`${styles.skillBadge} ${styles.hot}`}>Figma</span>
              <span className={`${styles.skillBadge} ${styles.hot}`}>Adobe XD</span>
              <span className={styles.skillBadge}>Framer</span>
          ...
          <div className={`${styles.heroImage} ${visible ? styles.visible : ''}`}>
            <div className={styles.heroCard}>
              ...
              {/* Profile image (Uncomment and add image to public folder) */}
              {/* <Image src="/Profile photo.jpeg" alt="Amrendra Kumar" fill style={{ objectFit: 'cover' }} priority /> */}
              
              <div className={`${styles.heroBadge} ${styles.badgeTop}`}>✦ Available for Work</div>
              <div className={`${styles.heroBadge} ${styles.badgeBottom}`}><span className={styles.num}>50+</span>Projects Done</div>
            </div>
          </div>
